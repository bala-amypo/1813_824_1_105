...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public List<Appointment> getAppointmentsForHost(Long hostId) {
        return appointmentRepository.findByAppointmentDate(LocalDate.now()); // placeholder, implement custom query if needed
    }

    @Override
    public List<Appointment> getAppointmentsForVisitor(Long visitorId) {
        return appointmentRepository.findByAppointmentDate(LocalDate.now()); // placeholder
    }
}
